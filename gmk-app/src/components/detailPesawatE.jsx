import us from "../assets/img/papa/posterE.png";
import { FaDownload } from "react-icons/fa6";
import videok3a from "../assets/video/Scissor lift.mp4";

function DetailPesawatE() {
  return (
    <>
        ...
        <div className="container">
          <div className="row px-4 align-items-center justify-content-center">
            ...
            <div className="col-md-6 order-1 order-md-2">
              <h1 className="mb-4">
                Pembinaan & Sertifikasi K3 Operator Scissor Lift
              </h1>
              <h5 className="mb-3">
                Informasi Pembinaan & Sertifikasi K3 Operator Scissor Lift
              </h5>
              <p>
