import us from "../assets/img/kebakaran/posterB.png";
import { FaDownload } from "react-icons/fa6";
import videok3b from "../assets/video/k3B.mp4";
        ...
        <div className="container">
          <div className="row px-4 align-items-center justify-content-center">
            ...
            <div className="col-md-6 order-1 order-md-2">
              <h1 className="mb-4">
                Pelatihan Koordinator Penanggulangan Kebakaran Tingkat B
              </h1>
              <h5 className="mb-3">
                Informasi Pelatihan Koordinator Penanggulangan Kebakaran Tingkat
                B
              </h5>
              <p>
